...
import io.github._0xmaxlab.module.RichJsonModule;
import io.github._0xmaxlab.module.RichJsonModuleManager;
import org.junit.jupiter.api.Test;
import io.github._0xmaxlab.other.RichJsonClassMapping;
import io.github._0xmaxlab.other.RichJsonConfig;
import io.github._0xmaxlab.other.RichJsonEnvironment;
...
public class RichJsonTest {
    ...
    void testConstructor() throws Exception {
        ...
        mappings.put("io.github._0xmaxlab.RichJsonTestClass", RichJsonTestClass.class);
        RichJsonClassMapping.addClassMappings(mappings);
        RichJsonClassMapping.addClassMappings(mappings);

        Map<String, Object> content = parseJson("""
                    {
                        "first=io.github._0xmaxlab.RichJsonTestClass": {
                            "value": 100,
                            "second": {
                                "fourth": "fourth"
                            }
                        },
                        "second==io.github._0xmaxlab.RichJsonTestClass::first": {
                            "third": "third"
                        }
                    }
                """);
