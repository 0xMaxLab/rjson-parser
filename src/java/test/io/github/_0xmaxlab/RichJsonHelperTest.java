...
public class RichJsonHelperTest {
    ...
    public void testMergeObjects() {
        ...
        data2.put("age", 17);
        obj2.put("data", data2);
        obj2.put("io/github/_0xmaxlab/other", obj3);
        ...
        data1.put("name", "obj1");
        obj1.put("data", data1);
        obj1.put("io/github/_0xmaxlab/other", obj2);
        ...
        assertSame(obj2, res.get("io/github/_0xmaxlab/other"));

        Map<String, Object> resOther = (Map<String, Object>) res.get("io/github/_0xmaxlab/other");
        ...
        assertSame(obj3, resOther.get("io/github/_0xmaxlab/other"));
        ...
        assertEquals(173, ((Map<String, Object>) res.get("data")).get("size"));
        assertSame(obj3, res.get("io/github/_0xmaxlab/other"));

        resOther = (Map<String, Object>) res.get("io/github/_0xmaxlab/other");
        assertEquals(10, resOther.get("x"));
        assertEquals(15, resOther.get("y"));
        assertEquals("obj3", ((Map<String, Object>) resOther.get("data")).get("name"));
